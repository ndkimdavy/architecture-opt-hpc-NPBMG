...
Le programme NAS (Numerical Aerodynamic Simulation) \cite{nasbenchmarks1994}, basé au centre de recherche NASA Ames, a identifié dès les années 90 que les outils d'évaluation de performance traditionnels n'étaient plus adaptés aux architectures massives.
...
Cette méthode consiste à définir les problèmes uniquement de manière algorithmique, laissant ainsi aux implémenteurs la liberté de choisir les structures de données \cite{nasbenchmarks1994}, l'allocation des processeurs et les langages les plus appropriés pour leur matériel.
