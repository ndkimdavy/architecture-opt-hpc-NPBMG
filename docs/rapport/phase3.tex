...
\begin{itemize}
    \item \texttt{resid} : Représente 47,85 \% du temps total. À l'intérieur de ce module, la boucle 26 (lignes 608-610) constitue la section la plus coûteuse avec 29,31 \% de la charge CPU à elle seule.
    \item \texttt{psinv} : Constitue le second goulot d'étranglement avec 19,36 \% du temps.
    \item \texttt{interp} : Apparaît comme un contributeur significatif avec 9,50 \% du temps total.
    \item \texttt{rprj3} : Complète ce profil avec 6,69 \% du temps.
\end{itemize}
