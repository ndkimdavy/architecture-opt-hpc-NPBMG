...
\begin{frame}{Le Duel Final : C++ Optimisé vs Fortran Natif}
    \centering
    \inputImage{figures/comparison_duel_report_amd_cpp_vs_f90_opt.png}{Duel final sur architecture AMD (r0: Fortran vs r1: C++ opt)}{0.8\textwidth}{!}{fig:duel_final}
...
\begin{frame}{Conclusion}
    \begin{itemize}
        ...
        \item \textbf{Architecture} : Le Fortran exploite nativement mieux le parallélisme (8 threads actifs contre 5 pour le C++), avec un ratio d'activité quasi parfait.
    \end{itemize}
    
    \begin{block}{Constat final}
        \centering \fontsize{8}{9}\selectfont
