\section[Optimisation]{Optimisation et Levée des Verrous sur AMD}
...
\begin{frame}{Impact Global sur AMD : Analyse des routines}
    \inputImage{figures/top_functions_amd_r1_opt.png}{Routines AMD optimisées (Analyse -R1)}{0.9\textwidth}{!}{fig:top_functions_amd_r1_opt}
