\section[Méthodologie]{Méthodologie et Plateformes de travail}
...
\begin{frame}{Fiabilisation de l'Environnement}
    ...
    \begin{block}{Objectif : Reproductibilité}
        Ces réglages visent à réduire le bruit système et à stabiliser l'exécution, garantissant ainsi une base de comparaison fiable entre les architectures et les langages.
    \end{block}
\end{frame}