\section[Analyse AMD]{Analyse des résultats sur AMD}
...
\begin{frame}{Identification des sections critiques (Option -R1)}
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \vspace{-0.4cm}
            \inputImage{figures/top_functions_amd_r1.png}{Analyse -R1 : Routines dominantes (AMD)}{0.9\textwidth}{!}{fig:top_functions_amd_r1}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Fiabilité et Stabilité des mesures (Option -S1)}
    ...
    \inputImage{figures/stability_analysis_amd_s1.png}{Analyse -S1 : Stabilité des mesures (AMD)}{0.9\textwidth}{!}{fig:stability_analysis_amd_s1}
...
\begin{frame}{Étude de la montée en charge (Option -WS)}
    ...
    \inputImage{figures/scalability_speedup_amd_ws.png}{Analyse -WS : Scalabilité (AMD)}{0.8\textwidth}{!}{fig:scalability_speedup_amd_ws}
...
\begin{frame}{Duel de Paradigmes : Fortran 90 vs C++}
    ...
    \inputImage{figures/comparison_duel_report_amd.png}{Comparaison de performance : Fortran vs C++}{0.8\textwidth}{!}{fig:comparison_duel_report_amd}
